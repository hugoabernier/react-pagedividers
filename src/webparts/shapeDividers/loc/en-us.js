define([], function () {
  return {
    TopFieldLabel: "Vertical alignment",
    TopFieldOffText: "Align to bottom",
    TopFieldOnText: "Align to top",
    BasicGroupName: "Shape",
    ColorGroupName: "Color",
    CustomShapeGradientLabel: "Gradient",
    ...
    HorizontalFlipFieldLabel: "Horizontal direction",
